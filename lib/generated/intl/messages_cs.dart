...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "help_game_control_blind_title" : MessageLookupByLibrary.simpleMessage("Styl slepec"),
    "help_game_control_narrator_par_1" : MessageLookupByLibrary.simpleMessage("Jeden z hráčů vidí hádáný termín a popisuje jej, ostatní jej nevidí a hádají. Odpověď lze označit tlačítky."),
    "help_game_control_narrator_title" : MessageLookupByLibrary.simpleMessage("Styl vypravěc"),
    "help_game_control_score_par_1" : MessageLookupByLibrary.simpleMessage("V nastaveních zvolte neomezenou délku hry. Hra trvá dokud nedojou termíny. Kdo má nejvíce uhodnuto?"),
    ...
    "help_game_control_title" : MessageLookupByLibrary.simpleMessage("Ovládání hry"),
    ...
    "help_how_to_play_par_2" : MessageLookupByLibrary.simpleMessage("Způsob ovládání lze změnit v nastaveních, která jsou k dispozici na hlavní obrazovce pod symbolem ozubeného kola."),
    "help_how_to_play_tilt_par_1" : MessageLookupByLibrary.simpleMessage("Telefon je nutné mít přiskutý na čele. Správná odpověď se zvolí naklopením displeje dolu, špatná naklopením nahoru."),
